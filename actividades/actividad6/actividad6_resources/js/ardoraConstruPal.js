...
$("#help_div").html("<img id='playSound' class='imaLeft' src='actividad6_resources/media/' alt='Sound' align='left'>"+ "<p>" +ConstruPalWords(cp_que[jobindex[indexGame-1]])+ "</p>");
...
if (posX>400-$(iDiv).outerWidth()-2){posX=0;posY=posY+$(iDiv).outerHeight()+2;}$(iDiv).on("touchstart click", function() {if ($(this).hasClass("bg")) {$(this).addClass("bg_sol");
